...
class TestOperations(unittest.TestCase):
    ...
    def test_ror(self):
        self._test_play(b'\x6A', (0x8001, 0x00, 0x01, 0x00, 0x00, 0x00), a=0x02)
        self._test_play(b'\x6A', (0x8001, 0x00, 0x02, 0x00, 0x00, 0x01), a=0x05) # rotate out carry
        self._test_play(b'\x6A', (0x8001, 0x00, 0x00, 0x00, 0x00, 0x03), a=0x01) # rotate out carry, zero
        self._test_play(b'\x6A', (0x8001, 0x00, 0xC0, 0x00, 0x00, 0x81), a=0x81, p=0x01) # rotate in/out carry
        self._test_play(b'\x6A', (0x8001, 0x00, 0x80, 0x00, 0x00, 0x80), a=0x00, p=0x01) # rotate in
        self._test_play(b'\x66\x00', (0x8002, 0x00, 0x00, 0x00, 0x00, 0x81), p=0x01, mem_patches=[(0x00, b'\xD5')], expected_mem_patches=[(0x00, b'\xEA')])
        self._test_play(b'\x76\x00', (0x8002, 0x00, 0x00, 0x0F, 0x00, 0x81), p=0x01, mem_patches=[(0x0F, b'\xD5')], x=0x0F, expected_mem_patches=[(0x0F, b'\xEA')])
        self._test_play(b'\x6E\x00\x02', (0x8003, 0x00, 0x00, 0x00, 0x00, 0x81), p=0x01, mem_patches=[(0x0200, b'\xD5')], expected_mem_patches=[(0x0200, b'\xEA')])
        self._test_play(b'\x7E\x00\x02', (0x8003, 0x00, 0x00, 0x0F, 0x00, 0x81), p=0x01, mem_patches=[(0x020F, b'\xD5')], x=0x0F, expected_mem_patches=[(0x020F, b'\xEA')])