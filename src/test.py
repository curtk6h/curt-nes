...
class TestOperations(unittest.TestCase):
    ...
    def _test_play(self, prg_rom, expected_registers, pc=0x8000, sp=0x00, a=0x00, x=0x00, y=0x00, p=0x00, mem_patches=[], expected_mem_patches=[]):
    ...
    def test_lda_immediate(self):
        self._test_play(b'\xA9\x37', (0x8002, 0x00, 0x37, 0x00, 0x00, 0x00))
        self._test_play(b'\xA9\x00', (0x8002, 0x00, 0x00, 0x00, 0x00, 0x02))
        self._test_play(b'\xA9\x80', (0x8002, 0x00, 0x80, 0x00, 0x00, 0x80))
        self._test_play(b'\xA9\xFF', (0x8002, 0x00, 0xFF, 0x00, 0x00, 0x80))

    def test_lda_zero_page(self):
        self._test_play(b'\xA5\x00', (0x8002, 0x00, 0x37, 0x00, 0x00, 0x00), mem_patches=[(0x00, b'\x37')])
        self._test_play(b'\xA5\x80', (0x8002, 0x00, 0x37, 0x00, 0x00, 0x00), mem_patches=[(0x80, b'\x37')])
        self._test_play(b'\xA5\xFF', (0x8002, 0x00, 0x37, 0x00, 0x00, 0x00), mem_patches=[(0xFF, b'\x37')])
        self._test_play(b'\xA5\x12', (0x8002, 0x00, 0x37, 0x00, 0x00, 0x00), mem_patches=[(0x12, b'\x37')])
        self._test_play(b'\xA5\x13', (0x8002, 0x00, 0x00, 0x00, 0x00, 0x02), mem_patches=[(0x13, b'\x00')])
        self._test_play(b'\xA5\x14', (0x8002, 0x00, 0x80, 0x00, 0x00, 0x80), mem_patches=[(0x14, b'\x80')])
        self._test_play(b'\xA5\x15', (0x8002, 0x00, 0xFF, 0x00, 0x00, 0x80), mem_patches=[(0x15, b'\xFF')])

    def test_lda_zero_page_indexed_x(self):
        self._test_play(b'\xB5\x00', (0x8002, 0x00, 0x37, 0x0F, 0x00, 0x00), mem_patches=[(0x0F, b'\x37')], x=0x0F)
        self._test_play(b'\xB5\x80', (0x8002, 0x00, 0x37, 0x0F, 0x00, 0x00), mem_patches=[(0x8F, b'\x37')], x=0x0F)
        self._test_play(b'\xB5\xFF', (0x8002, 0x00, 0x37, 0x0F, 0x00, 0x00), mem_patches=[(0x0E, b'\x37')], x=0x0F)
        self._test_play(b'\xB5\x12', (0x8002, 0x00, 0x37, 0x0F, 0x00, 0x00), mem_patches=[(0x21, b'\x37')], x=0x0F)
        self._test_play(b'\xB5\x13', (0x8002, 0x00, 0x00, 0x0F, 0x00, 0x02), mem_patches=[(0x22, b'\x00')], x=0x0F)
        self._test_play(b'\xB5\x14', (0x8002, 0x00, 0x80, 0x0F, 0x00, 0x80), mem_patches=[(0x23, b'\x80')], x=0x0F)
        self._test_play(b'\xB5\x15', (0x8002, 0x00, 0xFF, 0x0F, 0x00, 0x80), mem_patches=[(0x24, b'\xFF')], x=0x0F)
    ...
    def test_ldx_zero_page_indexed_y(self):
        ...
        self._test_play(b'\xB6\x80', (0x8002, 0x00, 0x00, 0x37, 0x0F, 0x00), mem_patches=[(0x8F, b'\x37')], y=0x0F)
        self._test_play(b'\xB6\xFF', (0x8002, 0x00, 0x00, 0x37, 0x0F, 0x00), mem_patches=[(0x0E, b'\x37')], y=0x0F)
        self._test_play(b'\xB6\x12', (0x8002, 0x00, 0x00, 0x37, 0x0F, 0x00), mem_patches=[(0x21, b'\x37')], y=0x0F)
        self._test_play(b'\xB6\x13', (0x8002, 0x00, 0x00, 0x00, 0x0F, 0x02), mem_patches=[(0x22, b'\x00')], y=0x0F)
        self._test_play(b'\xB6\x14', (0x8002, 0x00, 0x00, 0x80, 0x0F, 0x80), mem_patches=[(0x23, b'\x80')], y=0x0F)
        self._test_play(b'\xB6\x15', (0x8002, 0x00, 0x00, 0xFF, 0x0F, 0x80), mem_patches=[(0x24, b'\xFF')], y=0x0F)

    def test_lda_absolute(self):
        self._test_play(b'\xAD\x00\x80', (0x8003, 0x00, 0xAD, 0x00, 0x00, 0x80))
        self._test_play(b'\xAD\x00\xC0', (0x8003, 0x00, 0x37, 0x00, 0x00, 0x00), mem_patches=[(0xC000, b'\x37')])
        self._test_play(b'\xAD\xFF\xFF', (0x8003, 0x00, 0x37, 0x00, 0x00, 0x00), mem_patches=[(0xFFFF, b'\x37')])
        self._test_play(b'\xAD\x12\x80', (0x8003, 0x00, 0x37, 0x00, 0x00, 0x00), mem_patches=[(0x8012, b'\x37')])
        self._test_play(b'\xAD\x13\x80', (0x8003, 0x00, 0x00, 0x00, 0x00, 0x02), mem_patches=[(0x8013, b'\x00')])
        self._test_play(b'\xAD\x14\x80', (0x8003, 0x00, 0x80, 0x00, 0x00, 0x80), mem_patches=[(0x8014, b'\x80')])
        self._test_play(b'\xAD\x15\x80', (0x8003, 0x00, 0xFF, 0x00, 0x00, 0x80), mem_patches=[(0x8015, b'\xFF')])

    def test_lda_absolute_indexed_x(self):
        self._test_play(b'\xBD\x00\x80', (0x8003, 0x00, 0x37, 0x0F, 0x00, 0x00), mem_patches=[(0x800F, b'\x37')], x=0x0F)
        self._test_play(b'\xBD\x00\xC0', (0x8003, 0x00, 0x37, 0x0F, 0x00, 0x00), mem_patches=[(0xC00F, b'\x37')], x=0x0F)
        self._test_play(b'\xBD\xFF\xFF', (0x8003, 0x00, 0x37, 0x0F, 0x00, 0x00), mem_patches=[(0x000E, b'\x37')], x=0x0F)
        self._test_play(b'\xBD\x12\x80', (0x8003, 0x00, 0x37, 0x0F, 0x00, 0x00), mem_patches=[(0x8021, b'\x37')], x=0x0F)
        self._test_play(b'\xBD\x13\x80', (0x8003, 0x00, 0x00, 0x0F, 0x00, 0x02), mem_patches=[(0x8022, b'\x00')], x=0x0F)
        self._test_play(b'\xBD\x14\x80', (0x8003, 0x00, 0x80, 0x0F, 0x00, 0x80), mem_patches=[(0x8023, b'\x80')], x=0x0F)
        self._test_play(b'\xBD\x15\x80', (0x8003, 0x00, 0xFF, 0x0F, 0x00, 0x80), mem_patches=[(0x8024, b'\xFF')], x=0x0F)

    def test_lda_absolute_indexed_y(self):
        self._test_play(b'\xB9\x00\x80', (0x8003, 0x00, 0x00, 0x0F, 0x01, 0x02), x=0x0F, y=0x01)
        self._test_play(b'\xB9\x00\xC0', (0x8003, 0x00, 0x37, 0x0F, 0x01, 0x00), mem_patches=[(0xC001, b'\x37')], x=0x0F, y=0x01)
        self._test_play(b'\xB9\xFF\xFF', (0x8003, 0x00, 0x37, 0x0F, 0x01, 0x00), mem_patches=[(0x0000, b'\x37')], x=0x0F, y=0x01)
        self._test_play(b'\xB9\x12\x80', (0x8003, 0x00, 0x37, 0x0F, 0x01, 0x00), mem_patches=[(0x8013, b'\x37')], x=0x0F, y=0x01)
        self._test_play(b'\xB9\x13\x80', (0x8003, 0x00, 0x00, 0x0F, 0x01, 0x02), mem_patches=[(0x8014, b'\x00')], x=0x0F, y=0x01)
        self._test_play(b'\xB9\x14\x80', (0x8003, 0x00, 0x80, 0x0F, 0x01, 0x80), mem_patches=[(0x8015, b'\x80')], x=0x0F, y=0x01)
        self._test_play(b'\xB9\x15\x80', (0x8003, 0x00, 0xFF, 0x0F, 0x01, 0x80), mem_patches=[(0x8016, b'\xFF')], x=0x0F, y=0x01)

    def test_lda_indexed_indirect(self):
        self._test_play(b'\xA1\x00', (0x8002, 0x00, 0x37, 0x0F, 0x01, 0x00), mem_patches=[(0x000F, b'\x00\x00'), (0x0000, b'\x37')], x=0x0F, y=0x01)
        self._test_play(b'\xA1\x00', (0x8002, 0x00, 0x37, 0x0F, 0x01, 0x00), mem_patches=[(0x000F, b'\x00\xC0'), (0xC000, b'\x37')], x=0x0F, y=0x01)
        self._test_play(b'\xA1\x00', (0x8002, 0x00, 0x37, 0x0F, 0x01, 0x00), mem_patches=[(0x000F, b'\xFF\xFF'), (0xFFFF, b'\x37')], x=0x0F, y=0x01)
        self._test_play(b'\xA1\xC0', (0x8002, 0x00, 0x37, 0x0F, 0x01, 0x00), mem_patches=[(0x00CF, b'\x00\xC0'), (0xC000, b'\x37')], x=0x0F, y=0x01)
        self._test_play(b'\xA1\xFF', (0x8002, 0x00, 0x37, 0x0F, 0x01, 0x00), mem_patches=[(0x000E, b'\x00\xC0'), (0xC000, b'\x37')], x=0x0F, y=0x01)

    def test_lda_indirect_indexed(self):
        self._test_play(b'\xB1\x00', (0x8002, 0x00, 0x37, 0x01, 0x0F, 0x00), mem_patches=[(0x0000, b'\x00\x00'), (0x000F, b'\x37')], x=0x01, y=0x0F)
        self._test_play(b'\xB1\x00', (0x8002, 0x00, 0x37, 0x01, 0x0F, 0x00), mem_patches=[(0x0000, b'\x00\xC0'), (0xC00F, b'\x37')], x=0x01, y=0x0F)
        self._test_play(b'\xB1\x00', (0x8002, 0x00, 0x37, 0x01, 0x0F, 0x00), mem_patches=[(0x0000, b'\xFF\xFF'), (0x000E, b'\x37')], x=0x01, y=0x0F)
        self._test_play(b'\xB1\xC0', (0x8002, 0x00, 0x37, 0x01, 0x0F, 0x00), mem_patches=[(0x00C0, b'\x00\xC0'), (0xC00F, b'\x37')], x=0x01, y=0x0F)
        self._test_play(b'\xB1\xFF', (0x8002, 0x00, 0x37, 0x01, 0x0F, 0x00), mem_patches=[(0x00FF, b'\x00\xC0'), (0xC00F, b'\x37')], x=0x01, y=0x0F)
    ...
    def test_bpl(self):
        self._test_play(b'\x10\x02', (0x8002, 0x00, 0x00, 0x00, 0x00, 0x80), p=0x80) # no branch
        self._test_play(b'\x10\x02', (0x8004, 0x00, 0x00, 0x00, 0x00, 0x00), p=0x00) # branch
        self._test_play(b'\x10\x02\x00\x00\xEA', (0x8005, 0x00, 0x00, 0x00, 0x00, 0x00), p=0x00) # branch to nop
        self._test_play(b'\x00\x10\xFD', (0x8000, 0x00, 0x00, 0x00, 0x00, 0x00), p=0x00, pc=0x8001) # branch negative address

    def test_bmi(self):
        self._test_play(b'\x30\x02', (0x8002, 0x00, 0x00, 0x00, 0x00, 0x00), p=0x00) # no branch
        self._test_play(b'\x30\x02', (0x8004, 0x00, 0x00, 0x00, 0x00, 0x80), p=0x80) # branch

    def test_bvc(self):
        self._test_play(b'\x50\x02', (0x8002, 0x00, 0x00, 0x00, 0x00, 0x40), p=0x40) # no branch
        self._test_play(b'\x50\x02', (0x8004, 0x00, 0x00, 0x00, 0x00, 0x00), p=0x00) # branch

    def test_bvs(self):
        self._test_play(b'\x70\x02', (0x8002, 0x00, 0x00, 0x00, 0x00, 0x00), p=0x00) # no branch
        self._test_play(b'\x70\x02', (0x8004, 0x00, 0x00, 0x00, 0x00, 0x40), p=0x40) # branch

    def test_bcc(self):
        self._test_play(b'\x90\x02', (0x8002, 0x00, 0x00, 0x00, 0x00, 0x01), p=0x01) # no branch
        self._test_play(b'\x90\x02', (0x8004, 0x00, 0x00, 0x00, 0x00, 0x00), p=0x00) # branch

    def test_bcs(self):
        self._test_play(b'\xB0\x02', (0x8002, 0x00, 0x00, 0x00, 0x00, 0x00), p=0x00) # no branch
        self._test_play(b'\xB0\x02', (0x8004, 0x00, 0x00, 0x00, 0x00, 0x01), p=0x01) # branch

    def test_bne(self):
        self._test_play(b'\xD0\x02', (0x8002, 0x00, 0x00, 0x00, 0x00, 0x02), p=0x02) # no branch
        self._test_play(b'\xD0\x02', (0x8004, 0x00, 0x00, 0x00, 0x00, 0x00), p=0x00) # branch

    def test_beq(self):
        self._test_play(b'\xF0\x02', (0x8002, 0x00, 0x00, 0x00, 0x00, 0x00), p=0x00) # no branch
        self._test_play(b'\xF0\x02', (0x8004, 0x00, 0x00, 0x00, 0x00, 0x02), p=0x02) # branch
