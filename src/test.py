...
class TestOperations(unittest.TestCase):
    ...
    def test_bpl(self):
        ...
        self._test_play(b'', (0x8100, 0x00, 0x00, 0x00, 0x00, 0x00), 5, pc=0x807F, p=0x00, mem_patches=[(0x807F, b'\x10\x7F')]) # branch / page crossed
        ...
        self._test_play(b'\x10\xFD', (0x7FFF, 0x00, 0x00, 0x00, 0x00, 0x00), 5, p=0x00) # branch negative address / page crossed
