...
class TestOperations(unittest.TestCase):
    ...
    def test_adc(self):
        ...
        self._test_play(b'\x6D\x00\x02\x00', (0x8003, 0x00, 0x49, 0x00, 0x00, 0x00), a=0x37, mem_patches=[(0x0200, b'\x12')])
        self._test_play(b'\x7D\x00\x02\x00', (0x8003, 0x00, 0x49, 0x0F, 0x00, 0x00), a=0x37, mem_patches=[(0x020F, b'\x12')], x=0x0F)
        self._test_play(b'\x79\x00\x02\x00', (0x8003, 0x00, 0x49, 0x01, 0x0F, 0x00), a=0x37, x=0x01, y=0x0F, mem_patches=[(0x020F, b'\x12')])
        self._test_play(b'\x61\x00\x00', (0x8002, 0x00, 0x37, 0x0F, 0x01, 0x00), a=0x01, mem_patches=[(0x000F, b'\x00\x00'), (0x0000, b'\x36')], x=0x0F, y=0x01)
        self._test_play(b'\x71\x00\x00', (0x8002, 0x00, 0x37, 0x01, 0x0F, 0x00), a=0x01, mem_patches=[(0x0000, b'\x00\x00'), (0x000F, b'\x36')], x=0x01, y=0x0F)
    ...
    def test_and(self):
        ...
        self._test_play(b'\x2D\x00\x02\x00', (0x8003, 0x00, 0x0A, 0x00, 0x00, 0x00), a=0xAA, mem_patches=[(0x0200, b'\x5A')])
        self._test_play(b'\x3D\x00\x02\x00', (0x8003, 0x00, 0x0A, 0x0F, 0x00, 0x00), a=0xAA, mem_patches=[(0x020F, b'\x5A')], x=0x0F)
        self._test_play(b'\x39\x00\x02\x00', (0x8003, 0x00, 0x0A, 0x01, 0x0F, 0x00), a=0xAA, x=0x01, y=0x0F, mem_patches=[(0x020F, b'\x5A')])
        self._test_play(b'\x21\x00\x00', (0x8002, 0x00, 0x0A, 0x0F, 0x01, 0x00), a=0xAA, mem_patches=[(0x000F, b'\x00\x00'), (0x0000, b'\x5A')], x=0x0F, y=0x01)
        self._test_play(b'\x31\x00\x00', (0x8002, 0x00, 0x0A, 0x01, 0x0F, 0x00), a=0xAA, mem_patches=[(0x0000, b'\x00\x00'), (0x000F, b'\x5A')], x=0x01, y=0x0F)

    def test_asl(self):
        self._test_play(b'\x0A\x00', (0x8001, 0x00, 0x0A, 0x00, 0x00, 0x00), a=0x05)
        self._test_play(b'\x0A\x00', (0x8001, 0x00, 0xAA, 0x00, 0x00, 0x80), a=0x55) # negative
        self._test_play(b'\x0A\x00', (0x8001, 0x00, 0x00, 0x00, 0x00, 0x03), a=0x80) # zero, carry
        self._test_play(b'\x0A\x00', (0x8001, 0x00, 0x40, 0x00, 0x00, 0x01), a=0xA0) # carry
        self._test_play(b'\x0A\x00', (0x8001, 0x00, 0x00, 0x00, 0x00, 0x02), a=0x00) # zero
        self._test_play(b'\x06\x00\x00', (0x8002, 0x00, 0x00, 0x00, 0x00, 0x80), mem_patches=[(0x00, b'\x55')], expected_mem_patches=[(0x00, b'\xAA')])
        self._test_play(b'\x16\x00\x00', (0x8002, 0x00, 0x00, 0x0F, 0x00, 0x80), mem_patches=[(0x0F, b'\x55')], x=0x0F, expected_mem_patches=[(0x0F, b'\xAA')])
        self._test_play(b'\x0E\x00\x02\x00', (0x8003, 0x00, 0x00, 0x00, 0x00, 0x80), mem_patches=[(0x0200, b'\x55')], expected_mem_patches=[(0x0200, b'\xAA')])
        self._test_play(b'\x1E\x00\x02\x00', (0x8003, 0x00, 0x00, 0x0F, 0x00, 0x80), mem_patches=[(0x020F, b'\x55')], x=0x0F, expected_mem_patches=[(0x020F, b'\xAA')])
