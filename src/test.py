...
class TestPPU(unittest.TestCase):
    ...
    def test_render_nametable_with_pygame(self):
        ...
        test_pal = [((i*(255//3)), (i*(255//3)), (i*(255//3))) for i in range(4)]
        table_idx = 1
        nt_rows, nt_cols = (30, 32)
        at_rows, at_cols = (30//4, 32//4)
                    ...
                    for col in range(nt_cols):
                        ...
                        for fine_y in range(0, 8):
                            for fine_x in range(0, 8):
                                ...
                                p_lo = chr_rom[p_addr|0|fine_y]
                                p_hi = chr_rom[p_addr|8|fine_y]
                                # TODO: resolve palette (look at palette memory reference)
                                pal_idx = ((p_lo>>p_shift)&1) | (((p_hi>>p_shift)&1)<<1)
                                pixels[x+fine_x,y+fine_y] = test_pal[pal_idx]
