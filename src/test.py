...
class TestOperations(unittest.TestCase):
    ...
    def _test_play(self, prg_rom, expected_registers, mem_patches=[], a=0x00, x=0x00, y=0x00, p=0x00, expected_mem_patches=[]):
        ...
        registers, t = play(mapper, (0x8000, 0x00, a, x, y, p))
    ...
    def test_sbc(self):
        ...
        self._test_play(b'\xE9\x0F', (0x8002, 0x00, 0xF9, 0x00, 0x00, 0xC0), a=0x08, p=0x01) # borrow
        # self._test_play(b'\x69\x7E', (0x8002, 0x00, 0xFC, 0x00, 0x00, 0xC0), a=0x7E) # overflow, negative
        # self._test_play(b'\x69\xFE', (0x8002, 0x00, 0x7E, 0x00, 0x00, 0x41), a=0x80) # overflow, borrow
