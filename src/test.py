...
class TestOperations(unittest.TestCase):
    ...
    def _test_play(self, prg_rom, expected_registers, expected_t, pc=0x8000, s=0x00, a=0x00, x=0x00, y=0x00, p=0x00, mem_patches=[], expected_mem_patches=[]):
    ...
    def test_lda_indirect_indexed(self):
        ...
        self._test_play(b'\xB1\xFF', (0x8002, 0x00, 0x37, 0x01, 0x0F, 0x00), 5, mem_patches=[(0x00FF, b'\x00'), (0x0000, b'\xC0'), (0xC00F, b'\x37')], x=0x01, y=0x0F)
    ...
    def test_ldx(self):
        ...
        self._test_play(b'\xA6\x00', (0x8002, 0x00, 0x00, 0x37, 0x00, 0x00), 3, mem_patches=[(0x00, b'\x37')])
        self._test_play(b'\xB6\x00', (0x8002, 0x00, 0x00, 0x37, 0x0F, 0x00), 4, mem_patches=[(0x0F, b'\x37')], y=0x0F)
    ...
    def test_ldy(self):
        ...
        self._test_play(b'\xA4\x00', (0x8002, 0x00, 0x00, 0x00, 0x37, 0x00), 3, mem_patches=[(0x00, b'\x37')])
        self._test_play(b'\xB4\x00', (0x8002, 0x00, 0x00, 0x0F, 0x37, 0x00), 4, mem_patches=[(0x0F, b'\x37')], x=0x0F)
    ...
    def test_lsr(self):
        ...
        self._test_play(b'\x46\x00', (0x8002, 0x00, 0x00, 0x00, 0x00, 0x01), 5, mem_patches=[(0x00, b'\x6F')], expected_mem_patches=[(0x00, b'\x37')])
        self._test_play(b'\x56\x00', (0x8002, 0x00, 0x00, 0x0F, 0x00, 0x01), 6, mem_patches=[(0x0F, b'\x6F')], x=0x0F, expected_mem_patches=[(0x0F, b'\x37')])
        self._test_play(b'\x4E\x00\x02', (0x8003, 0x00, 0x00, 0x00, 0x00, 0x01), 6, mem_patches=[(0x0200, b'\x6F')], expected_mem_patches=[(0x0200, b'\x37')])
        self._test_play(b'\x5E\x00\x02', (0x8003, 0x00, 0x00, 0x0F, 0x00, 0x01), 7, mem_patches=[(0x020F, b'\x6F')], x=0x0F, expected_mem_patches=[(0x020F, b'\x37')])
    ...
    def test_adc(self):
        ...
        self._test_play(b'\x65\x00', (0x8002, 0x00, 0x49, 0x00, 0x00, 0x00), 3, a=0x37, mem_patches=[(0x00, b'\x12')])
        self._test_play(b'\x75\x00', (0x8002, 0x00, 0x49, 0x0F, 0x00, 0x00), 4, a=0x37, mem_patches=[(0x0F, b'\x12')], x=0x0F)
        self._test_play(b'\x6D\x00\x02', (0x8003, 0x00, 0x49, 0x00, 0x00, 0x00), 4, a=0x37, mem_patches=[(0x0200, b'\x12')])
        self._test_play(b'\x7D\x00\x02', (0x8003, 0x00, 0x49, 0x0F, 0x00, 0x00), 4, a=0x37, mem_patches=[(0x020F, b'\x12')], x=0x0F)
        self._test_play(b'\x79\x00\x02', (0x8003, 0x00, 0x49, 0x01, 0x0F, 0x00), 4, a=0x37, x=0x01, y=0x0F, mem_patches=[(0x020F, b'\x12')])
        self._test_play(b'\x61\x00', (0x8002, 0x00, 0x37, 0x0F, 0x01, 0x00), 6, a=0x01, mem_patches=[(0x000F, b'\x00\x00'), (0x0000, b'\x36')], x=0x0F, y=0x01)
        self._test_play(b'\x71\x00', (0x8002, 0x00, 0x37, 0x01, 0x0F, 0x00), 5, a=0x01, mem_patches=[(0x0000, b'\x00\x00'), (0x000F, b'\x36')], x=0x01, y=0x0F)
    ...
    def test_and(self):
        ...
        self._test_play(b'\x25\x00', (0x8002, 0x00, 0x0A, 0x00, 0x00, 0x00), 3, a=0xAA, mem_patches=[(0x00, b'\x5A')])
        self._test_play(b'\x35\x00', (0x8002, 0x00, 0x0A, 0x0F, 0x00, 0x00), 4, a=0xAA, mem_patches=[(0x0F, b'\x5A')], x=0x0F)
        self._test_play(b'\x2D\x00\x02', (0x8003, 0x00, 0x0A, 0x00, 0x00, 0x00), 4, a=0xAA, mem_patches=[(0x0200, b'\x5A')])
        self._test_play(b'\x3D\x00\x02', (0x8003, 0x00, 0x0A, 0x0F, 0x00, 0x00), 4, a=0xAA, mem_patches=[(0x020F, b'\x5A')], x=0x0F)
        self._test_play(b'\x39\x00\x02', (0x8003, 0x00, 0x0A, 0x01, 0x0F, 0x00), 4, a=0xAA, x=0x01, y=0x0F, mem_patches=[(0x020F, b'\x5A')])
        self._test_play(b'\x21\x00', (0x8002, 0x00, 0x0A, 0x0F, 0x01, 0x00), 6, a=0xAA, mem_patches=[(0x000F, b'\x00\x00'), (0x0000, b'\x5A')], x=0x0F, y=0x01)
        self._test_play(b'\x31\x00', (0x8002, 0x00, 0x0A, 0x01, 0x0F, 0x00), 5, a=0xAA, mem_patches=[(0x0000, b'\x00\x00'), (0x000F, b'\x5A')], x=0x01, y=0x0F)
    ...
    def test_asl(self):
        ...
        self._test_play(b'\x06\x00', (0x8002, 0x00, 0x00, 0x00, 0x00, 0x80), 5, mem_patches=[(0x00, b'\x55')], expected_mem_patches=[(0x00, b'\xAA')])
        self._test_play(b'\x16\x00', (0x8002, 0x00, 0x00, 0x0F, 0x00, 0x80), 6, mem_patches=[(0x0F, b'\x55')], x=0x0F, expected_mem_patches=[(0x0F, b'\xAA')])
        self._test_play(b'\x0E\x00\x02', (0x8003, 0x00, 0x00, 0x00, 0x00, 0x80), 6, mem_patches=[(0x0200, b'\x55')], expected_mem_patches=[(0x0200, b'\xAA')])
        self._test_play(b'\x1E\x00\x02', (0x8003, 0x00, 0x00, 0x0F, 0x00, 0x80), 7, mem_patches=[(0x020F, b'\x55')], x=0x0F, expected_mem_patches=[(0x020F, b'\xAA')])

    def test_bit(self):
        self._test_play(b'\x24\x00', (0x8002, 0x00, 0x55, 0x00, 0x00, 0x00), 3, a=0x55, mem_patches=[(0x00, b'\x01')])
        self._test_play(b'\x24\x00', (0x8002, 0x00, 0xAA, 0x00, 0x00, 0x02), 3, a=0xAA, mem_patches=[(0x00, b'\x05')]) # zero
        self._test_play(b'\x24\x00', (0x8002, 0x00, 0xAA, 0x00, 0x00, 0x80), 3, a=0xAA, mem_patches=[(0x00, b'\xA0')]) # negative
        self._test_play(b'\x24\x00', (0x8002, 0x00, 0xAA, 0x00, 0x00, 0x40), 3, a=0xAA, mem_patches=[(0x00, b'\x42')]) # overflow
        self._test_play(b'\x24\x00', (0x8002, 0x00, 0xAA, 0x00, 0x00, 0xC0), 3, a=0xAA, mem_patches=[(0x00, b'\xF0')]) # negative, overflow
        self._test_play(b'\x2C\x00\x02', (0x8003, 0x00, 0x55, 0x00, 0x00, 0x00), 4, a=0x55, mem_patches=[(0x0200, b'\x01')])
    ...
    def test_sbc(self):
        ...
        self._test_play(b'\xE5\x00', (0x8002, 0x00, 0x25, 0x00, 0x00, 0x01), 3, a=0x37, p=0x01, mem_patches=[(0x00, b'\x12')])
        self._test_play(b'\xF5\x00', (0x8002, 0x00, 0x25, 0x0F, 0x00, 0x01), 4, a=0x37, p=0x01, mem_patches=[(0x0F, b'\x12')], x=0x0F)
        self._test_play(b'\xED\x00\x02', (0x8003, 0x00, 0x25, 0x00, 0x00, 0x01), 4, a=0x37, p=0x01, mem_patches=[(0x0200, b'\x12')])
        self._test_play(b'\xFD\x00\x02', (0x8003, 0x00, 0x25, 0x0F, 0x00, 0x01), 4, a=0x37, p=0x01, mem_patches=[(0x020F, b'\x12')], x=0x0F)
        self._test_play(b'\xF9\x00\x02', (0x8003, 0x00, 0x25, 0x01, 0x0F, 0x01), 4, a=0x37, p=0x01, x=0x01, y=0x0F, mem_patches=[(0x020F, b'\x12')])
        self._test_play(b'\xE1\x00', (0x8002, 0x00, 0x25, 0x0F, 0x01, 0x01), 6, a=0x37, p=0x01, mem_patches=[(0x000F, b'\x00\x02'), (0x0200, b'\x12')], x=0x0F, y=0x01)
        self._test_play(b'\xF1\x00', (0x8002, 0x00, 0x25, 0x01, 0x0F, 0x01), 5, a=0x37, p=0x01, mem_patches=[(0x0000, b'\x00\x02'), (0x020F, b'\x12')], x=0x01, y=0x0F)
    ...
    def test_cmp(self):
        ...
        self._test_play(b'\xC5\x00', (0x8002, 0x00, 0x37, 0x00, 0x00, 0x01), 3, a=0x37, p=0x01, mem_patches=[(0x00, b'\x12')])
        self._test_play(b'\xD5\x00', (0x8002, 0x00, 0x37, 0x0F, 0x00, 0x01), 4, a=0x37, p=0x01, mem_patches=[(0x0F, b'\x12')], x=0x0F)
        self._test_play(b'\xCD\x00\x02', (0x8003, 0x00, 0x37, 0x00, 0x00, 0x01), 4, a=0x37, p=0x01, mem_patches=[(0x0200, b'\x12')])
        self._test_play(b'\xDD\x00\x02', (0x8003, 0x00, 0x37, 0x0F, 0x00, 0x01), 4, a=0x37, p=0x01, mem_patches=[(0x020F, b'\x12')], x=0x0F)
        self._test_play(b'\xD9\x00\x02', (0x8003, 0x00, 0x37, 0x01, 0x0F, 0x01), 4, a=0x37, p=0x01, x=0x01, y=0x0F, mem_patches=[(0x020F, b'\x12')])
        self._test_play(b'\xC1\x00', (0x8002, 0x00, 0x37, 0x0F, 0x01, 0x01), 6, a=0x37, p=0x01, mem_patches=[(0x000F, b'\x00\x02'), (0x0200, b'\x12')], x=0x0F, y=0x01)
        self._test_play(b'\xD1\x00', (0x8002, 0x00, 0x37, 0x01, 0x0F, 0x01), 5, a=0x37, p=0x01, mem_patches=[(0x0000, b'\x00\x02'), (0x020F, b'\x12')], x=0x01, y=0x0F)
    ...
    def test_cpx(self):
        ...
        self._test_play(b'\xE4\x00', (0x8002, 0x00, 0x00, 0x37, 0x00, 0x01), 3, x=0x37, p=0x01, mem_patches=[(0x00, b'\x12')])
        self._test_play(b'\xEC\x00\x02', (0x8003, 0x00, 0x00, 0x37, 0x00, 0x01), 4, x=0x37, p=0x01, mem_patches=[(0x0200, b'\x12')])
    ...
    def test_cpy(self):
        ...
        self._test_play(b'\xC4\x00', (0x8002, 0x00, 0x00, 0x00, 0x37, 0x01), 3, y=0x37, p=0x01, mem_patches=[(0x00, b'\x12')])
        self._test_play(b'\xCC\x00\x02', (0x8003, 0x00, 0x00, 0x00, 0x37, 0x01), 4, y=0x37, p=0x01, mem_patches=[(0x0200, b'\x12')])
    ...
    def test_sta(self):
        self._test_play(b'\x85\x00', (0x8002, 0x00, 0xAA, 0x00, 0x00, 0x00), 3, a=0xAA, expected_mem_patches=[(0x00, b'\xAA')])
        self._test_play(b'\x95\x00', (0x8002, 0x00, 0xAA, 0x0F, 0x00, 0x00), 4, a=0xAA, expected_mem_patches=[(0x0F, b'\xAA')], x=0x0F)
        self._test_play(b'\x8D\x00\x02', (0x8003, 0x00, 0xAA, 0x00, 0x00, 0x00), 4, a=0xAA, expected_mem_patches=[(0x0200, b'\xAA')])
        self._test_play(b'\x9D\x00\x02', (0x8003, 0x00, 0xAA, 0x0F, 0x00, 0x00), 5, a=0xAA, expected_mem_patches=[(0x020F, b'\xAA')], x=0x0F)
        self._test_play(b'\x99\x00\x02', (0x8003, 0x00, 0xAA, 0x01, 0x0F, 0x00), 5, a=0xAA, x=0x01, y=0x0F, expected_mem_patches=[(0x020F, b'\xAA')])
        self._test_play(b'\x81\x00', (0x8002, 0x00, 0xAA, 0x0F, 0x01, 0x00), 6, a=0xAA, mem_patches=[(0x000F, b'\x00\x00')], expected_mem_patches=[(0x0000, b'\xAA')], x=0x0F, y=0x01)
    ...
    def test_php(self):
        self._test_play(b'\x08', (0x8001, 0xFE, 0x00, 0x00, 0x00, 0xAA), 3, s=0xFF, p=0xAA, expected_mem_patches=[(0x01FF, b'\xBA')])

    def test_plp(self):
        self._test_play(b'\x28', (0x8001, 0xFF, 0x00, 0x00, 0x00, 0xAA), 4, s=0xFE, p=0x00, mem_patches=[(0x01FF, b'\xAA')])

    def test_stx(self):
        self._test_play(b'\x86\x00', (0x8002, 0x00, 0x00, 0xAA, 0x00, 0x00), 3, x=0xAA, expected_mem_patches=[(0x00, b'\xAA')])
        self._test_play(b'\x96\x00', (0x8002, 0x00, 0x00, 0xAA, 0x0F, 0x00), 4, x=0xAA, expected_mem_patches=[(0x0F, b'\xAA')], y=0x0F)
        self._test_play(b'\x8E\x00\x02', (0x8003, 0x00, 0x00, 0xAA, 0x00, 0x00), 4, x=0xAA, expected_mem_patches=[(0x0200, b'\xAA')])

    def test_sty(self):
        self._test_play(b'\x84\x00', (0x8002, 0x00, 0x00, 0x00, 0xAA, 0x00), 3, y=0xAA, expected_mem_patches=[(0x00, b'\xAA')])
        self._test_play(b'\x94\x00', (0x8002, 0x00, 0x00, 0x0F, 0xAA, 0x00), 4, y=0xAA, expected_mem_patches=[(0x0F, b'\xAA')], x=0x0F)
        self._test_play(b'\x8C\x00\x02', (0x8003, 0x00, 0x00, 0x00, 0xAA, 0x00), 4, y=0xAA, expected_mem_patches=[(0x0200, b'\xAA')])
